...
def main():
    ...
    gelatin_box, gelatin_box_name = YCB_loader.get_ycb_object(obj_id="009_gelatin_box", 
                                                    pos=rBW_W, 
                                                    quat=q_WB)
  
    object_list = [gelatin_box]
    ...
    print('gelatin_box position')
    print(scene.get_obj_pos(obj_name = gelatin_box_name))


    

    target_obj_id = scene.get_obj_seg_id(obj_name=gelatin_box_name)

    print('for gelatin_box:')
    print(scene.get_obj_seg_id(obj_name=gelatin_box_name))
    ...
    print('final gelatin_box position')
    print(scene.get_obj_pos(obj_name = gelatin_box_name))
